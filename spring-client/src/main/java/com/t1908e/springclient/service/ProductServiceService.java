 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "http://service.springwebservie.example.com/", wsdlLocation = "http://localhost:8088/ws/products?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("http://service.springwebservie.example.com/", "ProductServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/ws/products?wsdl");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://service.springwebservie.example.com/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.springwebservie.example.com/", "ProductServicePort"), ProductService.class, features);
    }
